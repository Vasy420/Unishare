...
GOOGLE_DRIVE_REDIRECT_URI="https://signaling-fix.preview.emergentagent.com/api/drive/callback"
FRONTEND_URL="https://signaling-fix.preview.emergentagent.com"
```

### Frontend (.env)
```bash
REACT_APP_BACKEND_URL="https://signaling-fix.preview.emergentagent.com"
```
...
5. **Create OAuth Credentials**:
   ...
   - Authorized JavaScript origins: `https://signaling-fix.preview.emergentagent.com`
   - Authorized redirect URIs: `https://signaling-fix.preview.emergentagent.com/api/drive/callback`
