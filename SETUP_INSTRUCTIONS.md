...
GOOGLE_DRIVE_REDIRECT_URI="https://campus-share-1.preview.emergentagent.com/api/drive/callback"
FRONTEND_URL="https://campus-share-1.preview.emergentagent.com"
```

### Frontend (.env)
```bash
REACT_APP_BACKEND_URL="https://campus-share-1.preview.emergentagent.com"
```
...
5. **Create OAuth Credentials**:
   ...
   - Authorized JavaScript origins: `https://campus-share-1.preview.emergentagent.com`
   - Authorized redirect URIs: `https://campus-share-1.preview.emergentagent.com/api/drive/callback`
