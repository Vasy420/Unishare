...
GOOGLE_DRIVE_REDIRECT_URI="https://progress-forward-4.preview.emergentagent.com/api/drive/callback"
FRONTEND_URL="https://progress-forward-4.preview.emergentagent.com"
```

### Frontend (.env)
```bash
REACT_APP_BACKEND_URL="https://progress-forward-4.preview.emergentagent.com"
```
...
5. **Create OAuth Credentials**:
   ...
   - Authorized JavaScript origins: `https://progress-forward-4.preview.emergentagent.com`
   - Authorized redirect URIs: `https://progress-forward-4.preview.emergentagent.com/api/drive/callback`
