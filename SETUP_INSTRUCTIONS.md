...
GOOGLE_DRIVE_REDIRECT_URI="https://auth-drive-bridge.preview.emergentagent.com/api/drive/callback"
FRONTEND_URL="https://auth-drive-bridge.preview.emergentagent.com"
```

### Frontend (.env)
```bash
REACT_APP_BACKEND_URL="https://auth-drive-bridge.preview.emergentagent.com"
```
...
5. **Create OAuth Credentials**:
   ...
   - Authorized JavaScript origins: `https://auth-drive-bridge.preview.emergentagent.com`
   - Authorized redirect URIs: `https://auth-drive-bridge.preview.emergentagent.com/api/drive/callback`
