...
GOOGLE_DRIVE_REDIRECT_URI="https://button-repair-11.preview.emergentagent.com/api/drive/callback"
FRONTEND_URL="https://button-repair-11.preview.emergentagent.com"
```

### Frontend (.env)
```bash
REACT_APP_BACKEND_URL="https://button-repair-11.preview.emergentagent.com"
```
...
5. **Create OAuth Credentials**:
   ...
   - Authorized JavaScript origins: `https://button-repair-11.preview.emergentagent.com`
   - Authorized redirect URIs: `https://button-repair-11.preview.emergentagent.com/api/drive/callback`
