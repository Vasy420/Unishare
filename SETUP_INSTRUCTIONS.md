...
GOOGLE_DRIVE_REDIRECT_URI="https://error-fixer-63.preview.emergentagent.com/api/drive/callback"
FRONTEND_URL="https://error-fixer-63.preview.emergentagent.com"
```

### Frontend (.env)
```bash
REACT_APP_BACKEND_URL="https://error-fixer-63.preview.emergentagent.com"
```
...
5. **Create OAuth Credentials**:
   ...
   - Authorized JavaScript origins: `https://error-fixer-63.preview.emergentagent.com`
   - Authorized redirect URIs: `https://error-fixer-63.preview.emergentagent.com/api/drive/callback`
